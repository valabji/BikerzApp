        ...
        <View style={{ width: "100%", flex: 1 }}>
          <View style={{
            ...
            <View style={{ flex: 1, marginLeft: 15 }}>
              ...
              <Text style={{ fontSize: 16, textAlign: "left", fontFamily: t("regular") }}>{user.name} <Text style={{ fontSize: 12, color: Colors.DGray, textAlign: "left" }}>{user.vip ? <FontAwesome5 name="crown" /> : ""}{user.vip ? " 🇺🇸" : ""} </Text></Text>
              <Text style={{ fontSize: 12, color: Colors.DGray, textAlign: "left", fontFamily: t("regular"), marginTop: 5 }}>{t("msince")}{rdate(Number.parseInt(user.created))} </Text>
            </View>
          </View>
          <View style={{
            width,
            ...
            >
              ...
              <Text style={{ fontSize: 16, color: Colors.WHITE, textAlign: "left", fontFamily: t("regular") }}>{t("call")}</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text style={{ fontSize: 16, color: Colors.WHITE, textAlign: "left", fontFamily: t("regular") }}>{t("whatapp")}</Text>
            </TouchableOpacity>
          </View>
          {
            loading ?
              ...
              : data.length > 0 ?
                ...
                : <ScrollView refreshControl={<RefreshControl refreshing={false} onRefresh={() => { setLoading(true); setFt(true) }} />} contentContainerStyle={{ flexGrow: 1, justifyContent: "center", alignItems: "center" }} style={{ flex: 1 }}>
                  ...
                  <Text style={styles.noDataText}>{t("nooffers")}</Text>
                </ScrollView>
          }
